...
const { otpSend, verifyOtp, updateUser, getAllUser, selectclass, selectstream,deviceLicense, resendOTP, updategrade, getsubject, getvideos, updatestream, selectboard, selectlanguage, loginController, getUserProfile, userProfile,updatesubscription,checkExpiredSubscriptions,licenseProfile } = require('../controller/usercontroller')
...
userRoute.put('/profilelicense/:id',licenseProfile)
